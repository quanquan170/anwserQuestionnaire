...
/**
 *
 * @Description: 2007版本-xssf 注意poi版本为3.14
 * @Author sunShun
 * @Date 2021-1-13 10:08:11
 * @Version V1.0
 */
public class Excel2007 extends BaseExcel {
	...
	@Override
	public void open(MultipartFile file) throws IOException {
	...
	public void copyCellStyle(int srcRowIndex, int srcColIndex, int destRowIndex, int destColIndex) {
		XSSFCell srcCell = this.sheet.getRow(srcRowIndex).getCell(srcColIndex);
		if (srcCell != null) {
